...
# Kernel Autotune v2 is an intelligent system tuning utility designed to optimize Linux kernel parameters based on your specific hardware and running kernel. It provides predictable performance improvements by automatically detecting hardware and applying a tailored profile. Made for Windows switchers to Ubuntu to have an easier time. No Terminal or Reddit to figure out how to do the best settings. Best paired with: https://github.com/bobbycomet/Process-Sentry
